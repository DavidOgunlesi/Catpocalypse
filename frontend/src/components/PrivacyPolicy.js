...
export default function PrivacyPolicy(){
    ...
    return (
        ...
        <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to GROUP11 Inc., 5 Stocker Rd..</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Catpocalypse, accessible from <a href="https://catpocalpyse.com/" rel="external nofollow noopener" target="_blank">https://catpocalpyse.com</a></p>
        </li>
        <li>
